...
export const mockServices: Service[] = [
  { id: 'srv_001', categoria: 'CONSULTA', nombre: 'Consulta General', descripcion: 'Evaluación médica completa del paciente', precio: 45000, precioDescuento: null, proveedor: 'Veterinaria Ruffy', clinicaId: 'vet_001', ciudad: 'Santa Marta', modoServicio: 'AMBOS', estado: 'activo', fechaCreacion: '2026-01-15', fechaActualizacion: '2026-05-10' },
  { id: 'srv_002', categoria: 'CONSULTA', nombre: 'Consulta Domiciliaria', descripcion: 'Atención veterinaria a domicilio', precio: 75000, precioDescuento: null, proveedor: 'Veterinaria Ruffy', clinicaId: 'vet_001', ciudad: 'Santa Marta', modoServicio: 'A_DOMICILIO', estado: 'activo', fechaCreacion: '2026-01-15', fechaActualizacion: '2026-05-12' },
  { id: 'srv_003', categoria: 'CIRUGIA', nombre: 'Cirugía de Esterilización', descripcion: 'Procedimiento quirúrgico de esterilización canina/felina', precio: 120000, precioDescuento: null, proveedor: 'Clínica Veterinaria El Roble', clinicaId: 'vet_002', ciudad: 'Bogotá', modoServicio: 'EN_SEDE', estado: 'activo', fechaCreacion: '2026-01-20', fechaActualizacion: '2026-05-11' },
  { id: 'srv_004', categoria: 'VACUNAS', nombre: 'Vacuna Rabia', descripcion: 'Vacunación antirrábica anual', precio: 25000, precioDescuento: null, proveedor: 'Veterinaria San Marcos', clinicaId: 'vet_003', ciudad: 'Medellín', modoServicio: 'AMBOS', estado: 'activo', fechaCreacion: '2026-02-01', fechaActualizacion: '2026-05-08' },
  { id: 'srv_005', categoria: 'LABORATORIO', nombre: 'Panel Hemático Completo', descripcion: 'Análisis de sangre con 18 parámetros', precio: 85000, precioDescuento: null, proveedor: 'Centro Veterinario Andes', clinicaId: 'vet_004', ciudad: 'Cali', modoServicio: 'EN_SEDE', estado: 'activo', fechaCreacion: '2026-02-10', fechaActualizacion: '2026-05-14' },
  { id: 'srv_006', categoria: 'IMAGENES', nombre: 'Radiografía Digital', descripcion: 'Captura de imágenes radiográficas digitales', precio: 95000, precioDescuento: null, proveedor: 'Clínica Veterinaria El Roble', clinicaId: 'vet_002', ciudad: 'Bogotá', modoServicio: 'EN_SEDE', estado: 'activo', fechaCreacion: '2026-02-15', fechaActualizacion: '2026-05-13' },
  { id: 'srv_007', categoria: 'PROCEDIMIENTOS', nombre: 'Limpieza Dental', descripcion: 'Profilaxis dental con ultrasonido', precio: 75000, precioDescuento: null, proveedor: 'Veterinaria Ruffy', clinicaId: 'vet_001', ciudad: 'Santa Marta', modoServicio: 'AMBOS', estado: 'activo', fechaCreacion: '2026-03-01', fechaActualizacion: '2026-05-10' },
];
